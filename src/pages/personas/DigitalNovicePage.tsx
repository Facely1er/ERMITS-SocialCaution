...
const DigitalNovicePage: React.FC = () => {
  // Get priorities
    ...
    return [
      {
        ...
        description: "Essential security measures for beginners"
      },
      {
        icon: HelpCircle,
        title: "Privacy Education",
        description: "Learning the fundamentals of online privacy"
      },
      {
        icon: AlertTriangle,
        title: "Threat Awareness",
        description: "Recognizing common online risks and scams"
      }
    ];
  };
    ...
    return [
      {
        ...
        description: "Avoid easily guessed passwords. Use a password manager if needed.",
        difficulty: "Beginner",
        time: "15 minutes"
      },
      {
        title: "Configure Privacy Settings",
        description: "Review your online account settings to limit data sharing.",
        difficulty: "Beginner",
        time: "30 minutes"
      },
      {
        title: "Update Software Regularly",
        description: "Keep your system and apps updated to avoid vulnerabilities.",
        difficulty: "Beginner",
        time: "20 minutes"
      }
    ];
  ...
  const getTranslatedText = () => {
    return {
      ...
      description: "Learning the basics of online privacy and digital security with simple and essential tips.",
      recommendedActions: "Recommended Actions",
      readyToLearn: "Ready to Learn Privacy Basics?",
      startWithAssessment: "Start with our beginner privacy assessment to get personalized recommendations.",
    ...
    <Section>
      ...
      >
        ...
        <motion.div
          ...
          className="bg-warning p-8 rounded-lg text-center"
        >
          <h2 className="text-2xl font-bold text-white mb-4">{text.readyToLearn}</h2>
          ...
          <Link to="/assessment">
            <Button
              variant="primary"
              className="bg-white hover:bg-gray-100 text-warning"
            >
              {text.takeAssessment}
...
export default DigitalNovicePage;